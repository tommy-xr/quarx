...
namespace AnarchyEditor
{
    ...
    public static class Editor
    {
        ...
        static ContentManager editorContent;
        public static ContentManager EditorContent
        {
            get { return editorContent; }
        }

        static EditorAssets assets;
        public static EditorAssets Assets
        {
            get { return assets; }
        }
        ...
        public static void Initialize()
        {
           //TODO: Set editor path
            ...
            editorContent = new ContentManager(services);
            assets = new EditorAssets(editorContent);
