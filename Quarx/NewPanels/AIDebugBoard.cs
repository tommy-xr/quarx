...
namespace Quarx
{
    ...
    /// </summary>
    public class AIDebugBoard : CompositePanel
    {
        ...
        public override void LoadContent(Microsoft.Xna.Framework.Content.ContentManager content)
        {
            ...
            boardViewer = new AIBoardViewer3D(graphics.GraphicsDevice, content, BoardWidth, BoardHeight);
        }
